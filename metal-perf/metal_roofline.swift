...
// ┌─────────────┬──────────────────────┐
// │ Metric      │ M5 Pro (20-core)     │
// ├─────────────┼──────────────────────┤
// │ FP32  TFLOPS│   7.9 @  8 chains    │
// │ FP16  TFLOPS│  12.7 @ 32 chains    │
// │ BF16  TFLOPS│   8.2 @  8 chains    │
// │ INT16 GIOPS │   4.1 @  6 chains    │
// │ INT32 GIOPS │   4.1 @  5 chains    │
// │ INT64 GIOPS │   1.0 @  2 chains    │
// │ DRAM  GB/s  │   275 copy / 282 fill│
// │ L2    GB/s  │   729 copy @ 2MB     │
// │ L2 size     │  8-12 MB             │
// └─────────────┴──────────────────────┘
